var Starback = (() => {
  ...
  var S = (s, t, i) =>
      t in s
        ? D(s, t, { enumerable: !0, configurable: !0, writable: !0, value: i })
        : (s[t] = i),
    c = (s, t) => {
  ...
  var L = (s, t) => () => (t || s((t = { exports: {} }).exports, t), t.exports);
  function a(s, t) {
  ...
  var p,
    ...
    C = d(() => {
      ...
      (p = class {
        ...
        update() {
          ...
          for (let r = 0; r < this.stars.length; r++) {
            ...
            if (
              ((h.x += t * h.speed),
              (h.y += i * h.speed),
              h.x > this.canvas.width + this.overflowSize ||
                h.x < 0 - this.overflowSize ||
                h.y > this.canvas.height + this.overflowSize ||
                h.y < 0 - this.overflowSize)
            ) {
              ...
              i == -1 || i == 1
                ? ((e = 0),
                  ...
                  (n = i == 1 ? 0 : this.canvas.height))
                : t == -1 || t == 1
                ? ((e = t == 1 ? 0 : this.canvas.width),
                  (o = e + this.overflowSize * -t),
                  (n = a(0, this.canvas.height)))
                : t > 0 && i > 0
                ? ((e = -this.overflowSize),
                  (o = l([e, a(e, this.canvas.width - this.overflowSize)])),
                  (n =
                    o == e
                      ? a(e, this.canvas.height - this.overflowSize)
                      : -this.overflowSize))
                : t < 0 && i > 0
                ? ((e = -this.canvas.width + this.overflowSize),
                  (o = l([e, a(e, 0 + this.overflowSize)])),
                  (n =
                    o == e
                      ? a(e, 0 - this.canvas.height + this.overflowSize)
                      : -this.overflowSize))
                : t < 0 && i < 0
                ? ((e = this.canvas.width + this.overflowSize),
                  (o = l([e, a(e, 0 + this.overflowSize)])),
        ...
        randomSize() {
          return typeof this.config.starSize == "object"
            ? a(this.config.starSize[0], this.config.starSize[1])
            ...
            let i = a(-20, this.canvas.width),
              ...
              o =
                ...
                (this.canvas.width * this.config.distanceX +
                  this.config.spread * i * this.config.directionX),
              n = o - i,
      ...
      (k = {
        ...
        (u = class {
          constructor(t, i = {}) {
            ...
            (this.canvas =
              t instanceof HTMLCanvasElement ? t : document.querySelector(t)),
